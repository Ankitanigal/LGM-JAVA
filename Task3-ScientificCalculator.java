...
class Scientific_Calculator {
    ...
    // frame with their action listner
    private void initialize() {
        frmCalculator = new JFrame();
        frmCalculator.setResizable(false);
        frmCalculator.setTitle("Scientific_Calculator");
        frmCalculator.getContentPane().setBackground(new Color(212, 163, 115));
        ...
        Answer_textPanel.setBackground(new Color(183, 239, 197));
        ...
        frmCalculator.getContentPane().add(Answer_textPanel);
        ...
        button1.setBackground(new Color(122, 229, 130));
        button1.setFont(new Font("Tamoha", Font.BOLD, 19));
        ...
        button2.setBackground(new Color(147, 129, 255));
        ...
        // button for constant pi(3.14)
        JButton button3 = new JButton("pi");
        button3.setFont(new Font("Calibri Light", Font.PLAIN, 17));
        button3.setBackground(new Color(147, 129, 255));
        ...
        button4.setBackground(new Color(147, 129, 255));
        ...
        button5.setBackground(new Color(147, 129, 255));
        ...
        button6.setBackground(new Color(147, 129, 255));
        ...
        button7.setBackground(new Color(147, 129, 255));
        ...
        button8.setBackground(new Color(147, 129, 255));
        ...
        button9.setBackground(new Color(147, 129, 255));
        ...
        // button for squreroot
        JButton button10 = new JButton("Sqrt");
        button10.setBackground(new Color(147, 129, 255));
        ...
        button11.setBackground(new Color(147, 129, 255));
        ...
        button12.setBackground(new Color(184, 184, 255));
        ...
        button13.setBackground(new Color(184, 184, 255));
        ...
        button14.setBackground(new Color(184, 184, 255));
        ...
        button15.setBackground(new Color(147, 129, 255));
        ...
        button16.setBackground(new Color(147, 129, 255));
        ...
        button17.setBackground(new Color(184, 184, 255));
        ...
        button18.setBackground(new Color(184, 184, 255));
        ...
        button21.setBackground(new Color(147, 129, 255));
        ...
        button22.setBackground(new Color(184, 184, 255));
        ...
        button23.setBackground(new Color(184, 184, 255));
        ...
        button24.setBackground(new Color(184, 184, 255));
        button24.setFont(new Font("Calibri Light", Font.PLAIN, 17));
        butttonPanel.add(button24);

        JButton button25 = new JButton("-");
        button25.setBackground(new Color(147, 129, 255));
        ...
        button26.setBackground(new Color(147, 129, 255));
        ...
        button27.setBackground(new Color(147, 129, 255));
        ...
        button28.setBackground(new Color(184, 184, 255));
        ...
        button29.setBackground(new Color(122, 229, 130));
        button29.setFont(new Font("Tamoha", Font.BOLD, 25));
        button29.setForeground(Color.WHITE);
        butttonPanel.add(button29);

        JButton button30 = new JButton("+");
        button30.setBackground(new Color(147, 129, 255));
