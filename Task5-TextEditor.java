...
public class Notepad implements ActionListener, MenuConstants {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if (cmdText.equals(fileNew))
			...
			JOptionPane.showMessageDialog(Notepad.this.f, aboutText, "About Javapad", JOptionPane.INFORMATION_MESSAGE);
		} else
	...
	void createMenuBar(JFrame f) {
		...
		selectAllItem = createMenuItem(editSelectAll, KeyEvent.VK_A, editMenu,
				KeyEvent.VK_A, this);
...
interface MenuConstants {
	...
	final String formatForeground = "Choose Text color...";
	final String formatBackground = "Choose Background color...";

	final String helpAboutNotepad = "About Javapad";

	final String aboutText = "<html><big>Welcome To Notepad</big><hr><hr>"
			+ "<p align=right>Prepared by a Tanvi Kasture!"
			+ "<hr><p align=left>Advanced Level Task created using<br>"
			+ "<ul><li>Java</li><li>Java Swing</li><li>Java AWT</li><li>JTextArea</li><li>JMenuBar</li><li>JMenu</li><li>JMenuItems</li></ul><br>"
			+ "</big></em><hr><html>";
}